					...
					<form id="registerForm"  action="${pageContext.request.contextPath}/user_regist.action" method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" id="email" name="email" class="text" maxlength="200"><span>
									<font color="red"><s:fielderror fieldName="email"></s:fielderror></font></span>
								</td>
							</tr>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
												<input type="text" name="phoneNum" class="text" onfocus="WdatePicker();">
										</td>
									</tr>
