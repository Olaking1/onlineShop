		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<table>
					<tbody>
					<tr>
						<th clospan="5">订单编号：<s:property value="model.oid" /></th>
					</tr>
					<tr>
						<th>图片</th>
						<th>商品</th>
					...
					<s:iterator var="orderItem" value="model.orderItems">
						<tr>
							...
							<td>
								<a target="_blank"><s:property value="#model.product.pname"/></a>
							</td>
							<td>
							...
							<td width="140">
								<span class="subtotal">￥<s:property value="#orderItem.product.subtotal"/></span>
							</td>
